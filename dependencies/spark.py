...
This module helps with controlling Apache spark
"""
...
def start_spark(app_name='spark_analysis', master='local[*]', jar_packages=[], files=[], spark_config={}):
    ...
    spark_files_directory = SparkFiles.getRootDirectory()
    config_files = [filename for filename in listdir(spark_files_directory) if filename.endswith('config.json')]
